...
async () => {
         ...
         test('Verify contract.originate for a contract having empty metadata stored at an HTTPS URL', 
async () => {
        ...
        test('Verify that the metadata for the contract having empty metadata stored at an HTTPS URL can be fetched', 
async () => {
         ...
         test('Verify contract.originate for a contract having valid metadata stored at an HTTPS URL', 
async () => {
        ...
        test('Verify contract.originate for a contract having valid metadata which contains emoji stored at an HTTPS URL', 
async () => {
        ...
        test('Verify that the metadata for the contract which contains emoji can be fetched', 
async () => {
        ...
        test('Verify contract.originate for a contract having invalid metadata stored at an HTTPS URL', 
async () => {
        ...
        test('Verify that the invalid metadata of the contract failed to fetch', 
async () => {
