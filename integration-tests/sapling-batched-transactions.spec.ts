...
async () => {
    ...
    it('Prepare and inject 3 batched shielded transactions', 
async () => {
    ...
    it('Verify balances after the shielded tx', 
async () => {
    ...
    it('Prepare and inject batched sapling transactions', 
async () => {
    ...
    it('Verify balances after the sapling transactions', 
async () => {
      const balance1 = await txViewer1.getBalance();
      const inputs1 = await txViewer1.getIncomingAndOutgoingTransactions();
