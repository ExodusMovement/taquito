...
async () => {
        ...
        describe('Test to verify that user can decline all prompts on the ledger device', () => {
            ...
            it('Verify that Ledger will throw an error when public key is declined', 
async () => {
            ...
            it('Verify that Ledger will throw an error when signing is declined', 
async () => {
                const signer = new LedgerSigner(
                    transport,
                    "44'/1729'/0'/0'",
            ...
            describe('Test that Ledger can be used with wallet API', () => {
                ...
                it('Verify that Ledger will throw an error when a transaction is declined', 
async () => {
                    const signer = new LedgerSigner(
                        transport,
                        "44'/1729'/0'/0'",
            ...
            describe('Should be able to use Ledger with contract API', () => {
                jest.setTimeout(60000)
                it('Should throw error when user declines to originate contract with Ledger', 
async () => {
                    const signer = new LedgerSigner(
                        transport,
                        "44'/1729'/0'/0'",
