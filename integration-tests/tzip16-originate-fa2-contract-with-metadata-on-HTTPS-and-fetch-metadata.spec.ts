...
async () => {
      ...
      it('Verify contract.originate for a Fa2 contract having metadata on HTTPS', 
async () => {
      ...
      it('Verify that metadata for a Fa2 contract can be fetched', 
async () => {
      ...
      it('Verify that Fa2 contract view can be executed', 
async () => {
