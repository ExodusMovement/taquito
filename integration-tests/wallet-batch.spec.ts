...
async () => {
        ...
        test('Verify wallet.batch simple transfers with origination code in JSON Michelson format', 
async () => {
        ...
        test('Verify wallet.batch simple transfers with origination code in Michelson format', 
async () => {
            const batch = Tezos.wallet
                .batch()
                .withTransfer({ to: 'tz1ZfrERcALBwmAqwonRXYVQBDT9BjNjBHJu', amount: 0.02 })
        ...
        test('Verify wallet.batch simple transfers with origination', 
async () => {
        ...
        test('Verify wallet.batch simple transfers from an account with low balance', 
async () => {
        ...
        test('Verify wallet.batch simple transfers with chained contract calls', 
async () => {
            const op = await Tezos.wallet
                .originate({
                    balance: '1',
        ...
        test('Verify wallet.batch with contract.method call', 
async () => {
        ...
        test('Batch multiple originations and get contract addresses info from getOriginatedContractAddresses member function', 
async () => {
            const batch = Tezos.wallet
              .batch()
              .withOrigination({
