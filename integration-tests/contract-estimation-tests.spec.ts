...
async () => {
    ...
    mumbainet('Verify .estimate.transfer with allocated destination', 
async () => {
    ...
    mumbainet('Verify .estimate.transfer with unallocated destination', 
async () => {
    ...
    mumbainet('Verify .estimate.originate simple contract', 
async () => {
    ...
    mumbainet('Verify .estimate.setDelegate result', 
async () => {
    ...
    mumbainet('Verify .estimate.transfer for internal transfer to allocated implicit', 
async () => {
    ...
    mumbainet('Verify .estimate.transfer for multiple internal transfers to unallocated account', 
async () => {
    ...
    mumbainet('Verify .estimate.transfer for internal origination', 
async () => {
    ...
    mumbainet('Verify .estimate.transfer for multiple internal originations', 
async () => {
...
async () => {
    ...
    it('Verify .estimate.transfer to regular address', 
async () => {
    ...
    it('Estimate transfer to regular address with a fixed fee', 
async () => {
    ...
    it('Estimate transfer to regular address with insufficient balance', 
async () => {
      await expect(
    ...
    it('Estimate transfer to regular address with insufficient balance to pay storage for allocation', 
async () => {
      await expect(
    ...
    it('Estimate origination with insufficient balance to pay storage', 
async () => {
