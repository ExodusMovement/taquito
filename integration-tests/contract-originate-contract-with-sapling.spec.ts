...
async () => {
    ...
    test('Originates a Sapling Double contract', 
async () => {
    ...
    test('Originates a Sapling Drop contract', 
async () => {
      const op = await Tezos.contract.originate({
    ...
    test('Originates a Sapling Send contract', 
async () => {
      const op = await Tezos.contract.originate({
    ...
    test('Originates a Sapling Contract State as Arg contract', 
async () => {
      const op = await Tezos.contract.originate({
    ...
    test('Should fail to originate a Push Sapling State contract', 
async () => {
      try {
    ...
    test('Originates a Use Existing State Sapling contract', 
async () => {
      const op = await Tezos.contract.originate({
