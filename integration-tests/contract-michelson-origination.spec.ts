...
async () => {
    ...
    it('uses noopParser to originate Michelson code and fails', 
async () => {
    ...
    it('uses MichelCodecParser to originate Michelson code and succeeds', 
async () => {
    ...
    it('no parser configured will use MichelCodecParser by default to originate Michelson code and succeeds', 
async () => {
...
async () => {
    ...
    it('Verify contract.originate for an ID contract written in plain Michelson', 
async () => {
      const op = await Tezos.contract.originate({
        balance: "0",
        code: idMichelsonCode,
    ...
    it('Origination should pass with balance as number', 
async () => {
      const op = await Tezos.contract.originate({
        balance: 0,
        code: idMichelsonCode,
    ...
    it('Origination should thow error if given NaN for balance', 
async () => {
