...
async () => {
    ...
    test('Verify contract.originate for a token contract and mints some tokens', 
async () => {
    ...
    test('Verify a token contract mints some tokens using the `methodObjects` method', 
async () => {
