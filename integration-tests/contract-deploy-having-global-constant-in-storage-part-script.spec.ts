...
async () => {
        ...
        test('deploy a voting contract having global constants in the storage part of its code using the contract API', 
async () => {
            try {
        ...
        test('deploy a voting contract having global constants in the storage part of its code using the wallet API', 
async () => {
        ...
        test('deploy a voting contract having global constants in the storage part of its code using the batch method of the contract API', 
async () => {
        ...
        test('deploy a voting contract having global constants in the storage part of its code using the batch method of the wallet API', 
async () => {
