...
async () => {
    ...
    it('should originate contract correctly with number passed into timestamp storage', 
async () => {
      const date = Date.now();
    ...
    it('should originate contract correctly with string passed into timestamp storage', 
async () => {
