...
async () => {
    ...
    test('Verify a Permit can be submitted and set', 
async () => {
    ...
    test('Verify contract.originate for a permit contract and expiry can be set', 
async () => {
      const op = await Tezos.contract.originate({
    ...
    test('Verify contract.originate for a permit contract and defaultExpiry can be set', 
async () => {
      const op = await Tezos.contract.originate({
        code: permit_admin_42_expiry,
        storage: {
    ...
    test('Verify contract.originate for a permit fa1.2 contract with metadata views', 
async () => {
