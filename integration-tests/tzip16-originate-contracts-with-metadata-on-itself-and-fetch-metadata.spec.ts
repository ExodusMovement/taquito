...
async () => {
        ...
        it('Verify contract.originate for a contract having metadata inside its own storage', 
async () => {
        ...
        it('Verify the metadata for a contract having metadata inside its own storage can be fetched', 
async () => {
        ...
        it('Verify contract.originate for a contract having metadata inside another contract same network', 
async () => {
        ...
        it('Verify that metadata for contract having metadata inside another contract on the same network can be fetched', 
async () => {
