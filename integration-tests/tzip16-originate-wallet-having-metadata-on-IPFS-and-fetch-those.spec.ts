...
async () => {
        ...
        test('Verify wallet.originate for a contract having metadata stored on IPFS', 
async () => {
    ...
    test('Verify that the metadata for the contract having metadata stored on IPFS can be fetched', 
async () => {
