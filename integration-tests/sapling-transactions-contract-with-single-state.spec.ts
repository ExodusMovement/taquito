...
async () => {
    ...
    it('Verify that the initial balance for Alice and Bob are 0 in the sapling contract', 
async () => {
    ...
    it('Verify that Alice can shield tokens', 
async () => {
    ...
    it("Verify that Alice's balance in the sapling pool updated after the shielded tx", 
async () => {
      const aliceSaplingToolkit = new SaplingToolkit({ saplingSigner: aliceInMemorySpendingKey }, { contractAddress: saplingContract.address, memoSize }, new RpcReadAdapter(Tezos.rpc))
      const aliceTxViewer = await aliceSaplingToolkit.getSaplingTransactionViewer();
    ...
    it('Verify that Alice can do a shielded transaction to Bob', 
async () => {
      const amountToBob = 2;
    ...
    it("Verify that Alice's balance in the sapling pool updated after the sapling tx", 
async () => {
      const aliceSaplingToolkit = new SaplingToolkit({ saplingSigner: aliceInMemorySpendingKey }, { contractAddress: saplingContract.address, memoSize }, new RpcReadAdapter(Tezos.rpc))
      const aliceTxViewer = await aliceSaplingToolkit.getSaplingTransactionViewer();
      const aliceBalance = await aliceTxViewer.getBalance();
    ...
    it('Verify that Alice can unshield tokens', 
async () => {
    ...
    it("Verify that Alice's balance in the sapling pool is updated after the unshielded tx", 
async () => {
      const aliceSaplingToolkit = new SaplingToolkit({ saplingSigner: aliceInMemorySpendingKey }, { contractAddress: saplingContract.address, memoSize }, new RpcReadAdapter(Tezos.rpc))
      const aliceTxViewer = await aliceSaplingToolkit.getSaplingTransactionViewer();
      const aliceBalance = await aliceTxViewer.getBalance();
