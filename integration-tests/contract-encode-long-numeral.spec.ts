...
async () => {
        ...
        test('Verify contract.originate for a contract and then call default method with long int param', 
async () => {
...
async () => {
        ...
        test('Verify wallet.originate for a contract and then call default method with long int param', 
async () => {
