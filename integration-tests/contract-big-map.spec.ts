...
async () => {
    ...
    it('Verify contract.originate with initialized Map with variants of data', 
async () => {
...
async () => {
    ...
    it('Originate contract and init bigmap to empty map', 
async () => {
      const op = await Tezos.contract.originate({
        balance: '1',
    ...
    it('originates a contract with empty bigmap and fetches the storage/bigmap', 
async () => {
      // Deploy a contract with a big map
      const op = await Tezos.contract.originate({
        balance: '1',
    ...
    it('Return undefined when BigMap key is not found', 
async () => {
    ...
    it('originates a contract with empty bigmap and fetches value in the bigMap using local packing', 
async () => {
    ...
    it('originate a contract with empty bigMap but represented with object literal', 
async () => {
      const signer = await Tezos.signer.publicKeyHash();
