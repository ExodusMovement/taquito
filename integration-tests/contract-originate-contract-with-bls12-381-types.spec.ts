...
async () => {
    ...
    it('Verify contract.originate for a contract with empty initial storage and update storage value via default method call with a hex string matching type bls12_381_g2', 
async () => {
      const op = await Tezos.contract.originate({
        code: `
