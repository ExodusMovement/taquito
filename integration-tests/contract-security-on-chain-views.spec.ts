...
async () => {
    ...
    mondaynet("Verify we can access the stack of the caller by using the instruction add.", 
async () => {
      try {
    ...
    mondaynet("Verify we can access the stack of the caller by using the instruction dig n", 
async () => {
      try {
        const opGetter = await Tezos.contract.originate({
          code: ` { parameter unit;
    ...
    mondaynet("Verify we can access the stack of the caller by using the instruction dup.", 
async () => {
      try {
        const opGetter = await Tezos.contract.originate({
          code: ` { parameter unit;
