...
async () => {
    ...
    it('should be able to prepare a transaction operation', 
async () => {
    ...
    it('should be able to prepare a batch operation', 
async () => {
    ...
    it('should be able to prepare a ballot operation', 
async () => {
    ...
    it('should be able to prepare a contractCall', 
async () => {
  ...
  describe('toPreapply conversion method', () => {
    it('Verify toPreaplyParams returns executable params for preapplyOperations', 
async () => {
  ...
  describe('toForge conversion method', () => {
    ...
    it('Verify that toForge is executable for both local forger and rpc.forgeOperations', 
async () => {
      const receiver = await createAddress();
      const pkh = await receiver.signer.publicKeyHash();
      const preparedTransfer = await Tezos.prepare.transaction({ amount: 1, to: pkh });
