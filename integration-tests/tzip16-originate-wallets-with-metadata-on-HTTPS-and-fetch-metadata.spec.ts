...
async () => {
         ...
         it('Verify wallet.originate for a contract having empty metadata stored at an HTTPS URL', 
async () => {
        ...
        it('Verify that the metadata for the contract having empty metadata stored at an HTTPS URL can be fetched', 
async () => {
         ...
         it('Verify wallet.originate for a contract having valid metadata stored at an HTTPS URL', 
async () => {
        ...
        it('Verify wallet.originate for a contract having valid metadata which contains emoji stored at an HTTPS URL', 
async () => {
        ...
        it('Verify that the metadata for the contract which contains emoji can be fetched', 
async () => {
        ...
        it('Verify contract.originate for a contract having invalid metadata stored at an HTTPS URL', 
async () => {
        ...
        it('Verify that the invalid metadata of the contract failed to fetch', 
async () => {
