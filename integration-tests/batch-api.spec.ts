...
async () => {
    ...
    it('Verify simple batch transfers with origination', 
async () => {
    ...
    it('Verify a batch of transfers and origination operations using a combination of the two notations (array of operation with kind mixed with withTransfer method)', 
async () => {
    ...
    it('Verify simple batch transfer with origination fails when storage_exhausted', 
async () => {
      expect.assertions(1);
      try {
        await Tezos.batch()
    ...
    it('Verify batch transfer and origination from an account with a low balance', 
async () => {
    ...
    it('Verify batch transfer with chained contract calls', 
async () => {
    ...
    it('Verify batch transfer with chained contract calls using the `methodsObject` method', 
async () => {
      const op = await Tezos.contract.originate({
        balance: "1",
        code: managerCode,
    ...
    it('Verify simple batch transfers with origination from code in Michelson format', 
async () => {
      const batch = Tezos.batch()
        .withTransfer({ to: 'tz1ZfrERcALBwmAqwonRXYVQBDT9BjNjBHJu', amount: 0.02 })
        .withTransfer({ to: 'tz1ZfrERcALBwmAqwonRXYVQBDT9BjNjBHJu', amount: 0.02 })
