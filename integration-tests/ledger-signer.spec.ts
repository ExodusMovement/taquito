...
async () => {
    ...
    describe('Verify retrieving the public key from the Ledger', () => {
      it('Verify that Ledger will provide correct public key and public key hash for tz1 curve and default path', 
async () => {
      ...
      it('Verify that Ledger will provide correct public key and public key hash for tz2 curve and default path', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/0'/0'",
      ...
      it('Verify that that Ledger will provide correct public key and public key hash for tz3 curve and path having 1 as account value', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/1'/0'",
    ...
    describe('Verify signing operation with Ledger Device', () => {
      ...
      it('Verify that Ledger returns the correct signature', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/0'/0'",
    ...
    describe('Verify the use of a Ledger Device with contract api', () => {
      ...
      it('Verify that a contract can be originated with Ledger', 
async () => {
    ...
    describe('Verify the use of a Ledger Device with wallet api', () => {
      ...
      it('Verify signing and injecting a transaction with Ledger', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/0'/0'",
    ...
    describe('Verify that use of a ledger device works with bip32_ed25519', () => {
      ...
      it('Verify that the pk and pkh is correct', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/1'/0'",
    ...
    describe('Verify bip32 signature', () => {
      jest.setTimeout(60000);
      it('Verify that the signature is correctly prefixed with originated contract', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/1'/0'",
      ...
      jest.setTimeout(60000);
      it('Verify that the signature is correct with set forged payload', 
async () => {
        const signer = new LedgerSigner(
          transport,
          "44'/1729'/1'/0'",
