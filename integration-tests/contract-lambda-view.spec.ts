...
CONFIGS().forEach(({ lib, rpc, setup }) => {
  ...
  describe(`Test contract with lambda view trough contract api using: ${rpc}`, () => {
    ...
    test('Verify contract.originate for FA1.2 contract and then fetch data from view entrypoints', 
async () => {
    ...
    test('Verify contract.originate for a contract and then fetch data from view entrypoints', 
async () => {
    ...
    test('Verify contract.originate for a FA2 contract and then fetch data from view entrypoints', 
async () => {
