...
async () => {
    ...
    rpcList.forEach(async (rpc) => {
      ...
      describe(`Test calling all methods from RPC node: ${rpc}`, () => {
        it('Verify rpcClient.getBlockHash returns the head block hash', 
async () => {
        ...
        it('Verify rpcClient.getLiveBlocks returns the ancestors of the head block', 
async () => {
        ...
        it(`Verify rpcClient.getBalance for known baker returns the balance of the address`, 
async () => {
        ...
        it(`Verify that rpcClient.getStorage for know contract returns the data of a contract`, 
async () => {
        ...
        it(`Verify that rpcClient.getScript for know contract returns the code and data of a contract`, 
async () => {
        ...
        it(`Verify that rpcClient.getNormalizedScript for known contract returns the script of the contract and normalize it using the requested unparsing mode`, 
async () => {
        ...
        it(`Verify that rpcClient.getContract returns the complete status of a contract`, 
async () => {
        ...
        it(`Verify that rpcClient.getManagerKey for known baker returns the manager key of the contract`, 
async () => {
        ...
        it(`Verify that rpcClient.getDelegate for known baker returns the delegate of the contract`, 
async () => {
        ...
        it(`Verify that rpcClient.getBigMapExpr for encoded expression returns the value associated with a key in a big map`, 
async () => {
        ...
        it(`Verify that rpcClient.getDelegates for known baker returns information about a delegate from RPC`, 
async () => {
        ...
        it(`Fetches voting information about a delegate from RPC`, 
async () => {
        ...
        it('Verify that rpcClient.getConstants returns all constants from RPC', 
async () => {
        ...
        it('Verify that rpcClient.getBlock returns all the information about a block', 
async () => {
        ...
        it('Verify that rpcClient.getBlockHeader returns whole block header', 
async () => {
        ...
        it('Verify that rpcClient.getBlockMetadata returns all metadata associated to the block', 
async () => {
        ...
        unrestrictedRPCNode('Verify that rpcClient.getBakingRights retrieves the list of delegates allowed to bake a block', 
async () => {
        ...
        unrestrictedRPCNode('Verify that rpcClient.getEndorsingRights retrieves the list of delegates allowed to endorse a block', 
async () => {
        ...
        it('Verify that rpcClient.getBallotList returns ballots casted so far during a voting period', 
async () => {
        ...
        it('Verify that rpcClient.getBallots returns sum of ballots casted so far during a voting period', 
async () => {
        ...
        it('Verify that rpcClient.getCurrentPeriod returns current period kind', 
async () => {
        ...
        it('Verify that rpcClient.getCurrentProposal returns current proposal under evaluation', 
async () => {
        ...
        it('Verify that rpcClient.getCurrentQuorum returns current expected quorum', 
async () => {
        ...
        it('Verify that rpcClient.getVotesListings returns list of delegates with their voting weight, in number of rolls', 
async () => {
        ...
        it('Verify that rpcClient.getProposals returns list of proposals with number of supporters', 
async () => {
        ...
        it('Verify that rpcClient.forgeOperations forges an operation and returns the unsigned bytes', 
async () => {
          const operation: any = {
        ...
        it('Verify that rpcClient.injectOperation injects an operation in node and broadcast it', 
async () => {
          try {
        ...
        it('Verify that rpcClient.preapplyOperations simulates the validation of an operation', 
async () => {
          try {
        ...
        it('Verify that rpcClient.getEntrypoints for known contract returns list of entrypoints of the contract', 
async () => {
        ...
        it('Verify that rpcClient.getChainId returns chain ID', 
async () => {
        ...
        it('Verify that rpcClient.runOperation runs an operation without signature checks', 
async () => {
          try {
            const chainId = await rpcClient.getChainId();
            expect(chainId).toBeDefined();
        ...
        it('Verify that rpcClient.runView executes tzip4 views', 
async () => {
        ...
        it('Verify that rpcClient.runScriptView executes michelson view', 
async () => {
          const chainId = await Tezos.rpc.getChainId();
        ...
        it('Verify that rpcClient.getSuccessorPeriod will get the voting period of next block', 
async () => {
        ...
        it('Verify that rpcClient.getSaplingDiffById will access the value associated with a sapling state ID', 
async () => {
        ...
        it('Verify that rpcClient.getSaplingDiffByContract will access the value associated with a sapling state', 
async () => {
        ...
        it('Verify that rpcClient.getProtocols will list past and present Tezos protocols', 
async () => {
        ...
        it('Verify that rpcClient.getStorageUsedSpace will retrieve the used space of a contract storage', 
async () => {
        ...
        it('Verify that rpcClient.getStoragePaidSpace will retrieve the paid space of a contract storage', 
async () => {
        ...
        it('Verify that rpcClient.ticketBalance will retrieve the specified ticket owned by the given contract', 
async () => {
        ...
        it('Verify that rpcClient.allTicketBalances will retrieve all tickets owned by the given contract', 
async () => {
        ...
        it('Verify that rpcClient.getPendingOperations will retrieve the pending operations in mempool', 
async () => {
        ...
        it('Verify that rpcClient.getOriginationProof will retrieve the proof needed for smart rollup originate', 
async () => {
