...
async () => {
        ...
        it('Verify contract.originate for a contract having metadata stored on IPFS', 
async () => {
        ...
        it('Verify that the metadata for the contract having metadata stored on IPFS can be fetched', 
async () => {
