...
async () => {
    ...
    it('Verify origination of a contract having a bigMap in its storage using contract.originate and the Storage/BigMap can be fetched', 
async () => {
    ...
    it('Verify that it returns undefined when BigMap key is not found', 
async () => {
    ...
    it('Verify contract.originate with BigMap and the value in the BigMap can be fetched using local packing', 
async () => {
