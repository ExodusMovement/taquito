...
describe('inmemory-signer', () => {
  ...
  it('fromFundraiser bad mnemonic', async () => {
    expect(() =>
  ...
  it('(tz1) Invalid key unable to decode', async () => {
    expect(function () {
  ...
  it('(tz2) Invalid key unable to decode', async () => {
    expect(function () {
  ...
  it('(tz3) Invalid key unable to decode', async () => {
    expect(function () {
  ...
  it('Should instantiate tz1 from mnemonic will throw an error with non-hardened derivation paths', async () => {
  ...
  it('Should instantiate tz1 from mnemonic will throw an error if path option is greater than 2^31', async () => {
    // good path: 44'/1729'/0'/0' || 44h/1729h/0h/0h
  ...
  it('Should instantiate tz1 from mnemonic will throw an error if path option NaN', async () => {
    // good path: 44'/1729'/0'/0' || 44h/1729h/0h/0h
  ...
  it('Should throw error if invalid mnemonic provided', async () => {
  ...
  it('Should throw error if bip32 requested', async () => {
    expect(() =>
  ...
  it('Should throw error with wrong curve', async () => {
